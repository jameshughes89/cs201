...
public interface BinarySearchTree<T extends Comparable<? super T>> extends Iterable<T> {
     ...
     * maintained. If multiple matching elements exist, only one is returned. If no such element exists a
    ...
    /**
     * Remove and return the minimum element contained in the binary search tree. What is considered as the minimum is
     * defined by the type's ordering. If multiple matching elements exist, only one is returned. If no such element
    ...
    /**
     * Remove and return the maximum element contained in the binary search tree. What is considered as the maximum is
     * defined by the type's ordering. If multiple matching elements exist, only one is returned. If no such element
     * exists a NoSuchElementException is thrown.
     *
    ...
    /**
     * Return the minimum element contained in the binary search tree. What is considered as the minimum is defined by
     * the type's ordering. After this method is called, the element remains in the tree. If no such element exists a
     * NoSuchElementException is thrown.
     *
     * @return Minimum/smallest element in the binary search tree
     */
    ...
    /**
     * Return the maximum element contained in the binary search tree. What is considered as the maximum is defined by
     * the type's ordering. After this method is called, the element remains in the tree. If no such element exists a
     * NoSuchElementException is thrown.
     *
     * @return Maximum/largest element in the binary search tree
    ...
    /**
     * Returns the number of occurrences of a specified element in the binary search tree.
     *
